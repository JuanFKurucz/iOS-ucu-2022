...
public extension Sequence where Element: Sequence {
    ...
    ///     // 1, 2, 100, 3, 4, 100, 5, 6
    @inlinable
    func joined(by separator: Element.Element)
...
public extension LazySequenceProtocol where Element: Sequence {
    /// Returns the concatenation of the elements in this sequence of sequences,
    /// inserting the separator produced by the closure between each sequence.
    @inlinable
    func joined(
...
public extension Collection where Element: Collection {
    ...
    ///     // 1, 2, 100, 200, 3, 4, 100, 200, 5, 6
    @inlinable
    func joined<Separator>(by separator: Separator)
...
public extension LazySequenceProtocol where Elements: Collection, Element: Collection {
    /// Returns the concatenation of the elements in this collection of
