...
public struct ChunkedByCollection<Base: Collection, Subject> {
    ...
    internal init(
        ...
        endOfFirstChunk = base.startIndex
...
public extension LazySequenceProtocol where Self: Collection, Elements: Collection {
