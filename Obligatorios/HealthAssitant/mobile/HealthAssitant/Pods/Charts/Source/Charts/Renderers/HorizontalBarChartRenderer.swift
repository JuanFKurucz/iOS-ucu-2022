...
open class HorizontalBarChartRenderer: BarChartRenderer {
    ...
    override public init(dataProvider: BarChartDataProvider, animator: Animator, viewPortHandler: ViewPortHandler)
    {
    ...
    override open func initBuffers() {
    ...
    private var _barShadowRectBuffer: CGRect = .init()
    ...
    override open func prepareBarHighlight(
        x: Double,
        y1: Double,
        y2: Double,
        barWidthHalf: Double,
    ...
    override open func isDrawingValuesAllowed(dataProvider: ChartDataProvider?) -> Bool {
        guard let data = dataProvider?.data
        else { return false }
        return data.entryCount < Int(CGFloat(dataProvider?.maxVisibleCount ?? 0) * viewPortHandler.scaleY)
    }

    /// Sets the drawing position of the highlight object based on the riven bar-rect.
    override internal func setHighlightDrawPos(highlight high: Highlight, barRect: CGRect) {
