...
open class YAxisRendererHorizontalBarChart: YAxisRenderer {
    override public init(viewPortHandler: ViewPortHandler, axis: YAxis, transformer: Transformer?) {
    ...
    override open func drawGridLine(
        context: CGContext,
        position: CGPoint
    ) {
        context.beginPath()
    ...
    override open func transformedPositions() -> [CGPoint] {
    ...
    override open func drawZeroLine(context: CGContext) {
        guard
