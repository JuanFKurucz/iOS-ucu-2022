...
open class ChartBaseDataSet: NSObject, ChartDataSetProtocol, NSCopying {
    ...
    open func calcMinMaxY(fromX _: Double, toX _: Double) {
    ...
    open func entryForIndex(_: Int) -> ChartDataEntry? {
    ...
    open func entryForXValue(
        _: Double,
        closestToY _: Double,
        rounding _: ChartDataSetRounding
    ) -> ChartDataEntry? {
    ...
    open func entriesForXValue(_: Double) -> [ChartDataEntry] {
    ...
    open func entryIndex(entry _: ChartDataEntry) -> Int {
        fatalError("entryIndex(entry) is not implemented in ChartBaseDataSet")
    }

    open func addEntry(_: ChartDataEntry) -> Bool {
    ...
    @discardableResult open func removeEntry(_: ChartDataEntry) -> Bool {
    ...
    open func contains(_: ChartDataEntry) -> Bool {
        fatalError("removeEntry is not implemented in ChartBaseDataSet")
    }
