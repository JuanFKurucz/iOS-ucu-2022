...
class ChartsViewController: UIViewController, ChartViewDelegate {
    ...
    @IBAction func onDiagnosticGraph(_: Any) {
        loadGraph(items: diagnosticItems, minValue: diagnosticRange[0], maxValue: diagnosticRange[1])
    }

    @IBAction func onSymptomGraph(_: Any) {
        loadGraph(items: symptomsItems, minValue: symptomsRange[0], maxValue: symptomsRange[1])
    }
